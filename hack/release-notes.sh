...
\`\`\`console
kubectl apply -f https://github.com/triggermesh/triggermesh-event-sources-bundle/releases/download/${RELEASE}/triggermesh-crds.yaml
\`\`\`

Install the TriggerMesh open source platform components:

\`\`\`console
kubectl apply -f https://github.com/triggermesh/triggermesh-event-sources-bundle/releases/download/${RELEASE}/triggermesh.yaml
\`\`\`
